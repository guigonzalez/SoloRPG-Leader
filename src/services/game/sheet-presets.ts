...
export interface SheetPreset {
  ...
  /** Item tags allowed for this preset (e.g. ['fantasy', 'generic']) */
  itemTags: string[];
...
export const SHEET_PRESETS: Record<string, SheetPreset> = {
  ...
  'cosmic-horror': {
    ...
    itemTags: ['horror', 'gothic', 'generic'],
  },
  ...
  'dark-future': {
    ...
    itemTags: ['cyberpunk', 'scifi', 'modern', 'generic'],
  },
  ...
  'gothic-vampire': {
    ...
    itemTags: ['gothic', 'horror', 'modern', 'generic'],
  },
...
export function migrateSystemToPreset(oldSystem: string): string {
  // If it's already a known presetId, keep it
  if (SHEET_PRESETS[oldSystem]) {
    return oldSystem;
  }

  // Otherwise treat it as a legacy/"system" name
